...
typedef struct gNB_MAC_INST_s {
  ...
  bool ul_mcs_scan_enabled;
  uint8_t ul_mcs_scan_ref;
  bool ul_mcs_scan_auto_sweep;
  uint8_t ul_mcs_scan_min_mcs;
  uint8_t ul_mcs_scan_max_mcs;
  uint32_t ul_mcs_scan_period;
  uint8_t ul_mcs_scan_start;
  uint32_t ul_mcs_scan_accum_frames;
  uint8_t ul_mcs_scan_current_index;
  uint16_t ul_mcs_scan_last_frame;
  uint32_t ul_mcs_scan_rb_period;
  uint32_t ul_mcs_scan_rb_accum_frames;
  uint16_t ul_mcs_scan_current_rb;
  uint16_t ul_mcs_scan_rb_per_mcs[29];
